...
HD_PWD='C:/Users/Gili/OneDrive/EGYETEM/Vik_msc1/scaler/scaler.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log backwards_mapping.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source backwards_mapping.tcl
